...
namespace findmyworkspace.Controllers
{
    public class LocationsController : Controller
    {
        ...
        public LocationsController(findmyworkspaceContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("LocationID,Name,Address,City,Type")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LocationID,Name,Address,City,Type")] Location location)
        {
